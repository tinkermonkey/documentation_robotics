 ...
 * - ArchiMate 3.2 metamodel patterns (layers 1, 2, 5, 6)
 * - OpenAPI 3.0 operation patterns (layer 7)
 * - NIST SP 800-53 control framework patterns (layer 4)
 * - React and router component patterns (layers 10, 11)
 *
