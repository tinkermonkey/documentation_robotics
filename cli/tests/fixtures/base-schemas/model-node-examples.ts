...
export const modelNodeExamples = {
  goalNode: {
    ...
    path: "motivation.goal.improve-customer-satisfaction",
  ...
  requirementNode: {
    ...
    path: "motivation.requirement.support-mobile-access",
  ...
  endpointNode: {
    ...
    path: "api.endpoint.create-customer",
  ...
  tableNode: {
    ...
    path: "data-store.table.customers",
  ...
  testCaseNode: {
    ...
    path: "testing.test-case.user-login-happy-path",
  ...
  minimalNode: {
    ...
    path: "custom.element.minimal-element",
  ...
  nodeWithoutMetadata: {
    ...
    path: "motivation.goal.another-goal",
    spec_node_id: "motivation.goal",
    type: "goal",
    layer_id: "motivation",
    name: "Another Goal",
