...
describe('stats command', () => {
  ...
  it('should display relationship statistics', async () => {
    ...
    // Add relationship
    await runDr(['relationship', 'add', 'motivation.goal.test-goal-1', 'business.service.test-service-1'], {
      cwd: tempDir.path,
    });
  ...
  it('should provide JSON with nested structure', async () => {
    ...
    await runDr(['add', 'api', 'endpoint', 'endpoint-1', '--name', 'Endpoint 1'], { cwd: tempDir.path });
