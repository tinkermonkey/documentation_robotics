...
class TestRealSpecification:
    """Test with actual spec directory structure."""
    ...
    def test_load_real_specification(self, real_spec_path):
        ...
        assert "version" in spec_data
        assert "layers" in spec_data
        assert len(spec_data["layers"]) == 12  # Should have all 12 layers
