...
/**
 * Test implementation of ClaudeIntegrationManager that allows mocking getProjectRoot
 */
class TestableClaudeIntegrationManager extends ClaudeIntegrationManager {
...
/**
 * Test suite for ClaudeIntegrationManager non-TTY guard implementation
 ...
 */
describe.serial("ClaudeIntegrationManager - Non-TTY Guards", () => {
  let tempDir: string;
  let targetDir: string;
  let projectRoot: string;
  let manager: TestableClaudeIntegrationManager;

  beforeEach(async () => {
    // Create temporary directories
    tempDir = await mkdtemp(join(tmpdir(), "dr-claude-manager-test-"));
    projectRoot = tempDir;
    ...
    // Mock the manager
    manager = new TestableClaudeIntegrationManager();
  ...
  describe("install() - non-TTY behavior", () => {
    it("should throw error in non-TTY when confirming overwrite without --force", async () => {
      ...
      const versionFile = join(targetDir, ".dr-version");
