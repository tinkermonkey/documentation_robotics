...
async function generateOpenAPISpec() {
  try {
    ...
    // AUTO-GENERATED: This file is automatically generated from server route definitions
    const specYaml = `# AUTO-GENERATED: This OpenAPI specification is generated from server route definitions.
# Do not edit this file manually. Instead, update route schemas in server.ts and run:
#   npm run generate:openapi
# This ensures the specification always matches the current implementation.
