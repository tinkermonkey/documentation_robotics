...
flowchart LR
  subgraph api
    ...
    externaldocumentation -->|associated-with| info
    externaldocumentation -->|serves| openapidocument
    externaldocumentation -->|serves| operation
    externaldocumentation -->|serves| schema
    ...
    openapidocument -->|requires| securityscheme
    ...
    operation -->|references| externaldocumentation
    ...
    servervariable -->|associated-with| parameter
    servervariable -->|governs| server
    servervariable -->|references| example
    servervariable -->|serves| operation
...
| api.openapidocument.realizes.application.applicationservice    | [Openapidocument](./06-api-layer-report.md#openapidocument)             | [Applicationservice](./04-application-layer-report.md#applicationservice)     | [Application](./04-application-layer-report.md) | realizes   | many-to-many | medium   |
...
| api.openapidocument.serves.application.applicationcomponent    | [Openapidocument](./06-api-layer-report.md#openapidocument)             | [Applicationcomponent](./04-application-layer-report.md#applicationcomponent) | [Application](./04-application-layer-report.md) | serves     | many-to-many | medium   |
...
| api.operation.realizes.application.applicationfunction         | [Operation](./06-api-layer-report.md#operation)                         | [Applicationfunction](./04-application-layer-report.md#applicationfunction)   | [Application](./04-application-layer-report.md) | realizes   | many-to-many | medium   |
...
| api.operation.references.application.applicationservice        | [Operation](./06-api-layer-report.md#operation)                         | [Applicationservice](./04-application-layer-report.md#applicationservice)     | [Application](./04-application-layer-report.md) | references | many-to-many | medium   |
...
| api.operation.triggers.application.applicationevent            | [Operation](./06-api-layer-report.md#operation)                         | [Applicationevent](./04-application-layer-report.md#applicationevent)         | [Application](./04-application-layer-report.md) | triggers   | many-to-many | medium   |
...
| api.operation.uses.application.applicationinterface            | [Operation](./06-api-layer-report.md#operation)                         | [Applicationinterface](./04-application-layer-report.md#applicationinterface) | [Application](./04-application-layer-report.md) | uses       | many-to-many | medium   |
...
| api.pathitem.serves.application.applicationcomponent           | [Pathitem](./06-api-layer-report.md#pathitem)                           | [Applicationcomponent](./04-application-layer-report.md#applicationcomponent) | [Application](./04-application-layer-report.md) | serves     | many-to-many | medium   |
...
| api.securityscheme.references.application.applicationcomponent | [Securityscheme](./06-api-layer-report.md#securityscheme)               | [Applicationcomponent](./04-application-layer-report.md#applicationcomponent) | [Application](./04-application-layer-report.md) | references | many-to-many | medium   |
| api.securityscheme.references.application.applicationservice   | [Securityscheme](./06-api-layer-report.md#securityscheme)               | [Applicationservice](./04-application-layer-report.md#applicationservice)     | [Application](./04-application-layer-report.md) | references | many-to-many | medium   |
...
| api.server.serves.application.applicationcomponent             | [Server](./06-api-layer-report.md#server)                               | [Applicationcomponent](./04-application-layer-report.md#applicationcomponent) | [Application](./04-application-layer-report.md) | serves     | many-to-many | medium   |
...
| ------------------------- | ---------- | --------- | ------------ |
| [Pathitem](#pathitem)     | aggregates | outbound  | many-to-many |
| [Server](#server)         | uses       | outbound  | many-to-many |
...
| [Example](#example)                 | aggregates      | outbound  | many-to-many |
| [Link node](#link)                  | aggregates      | outbound  | many-to-many |
| [Requestbody](#requestbody)         | aggregates      | outbound  | many-to-many |
| [Response](#response)               | aggregates      | outbound  | many-to-many |
| [Header](#header)                   | composes        | outbound  | many-to-many |
| [Parameter](#parameter)             | composes        | outbound  | many-to-many |
| [Paths](#paths)                     | composes        | outbound  | many-to-many |
| [Response](#response)               | composes        | outbound  | many-to-many |
| [Responses](#responses)             | composes        | outbound  | many-to-many |
| [Schema](#schema)                   | composes        | outbound  | many-to-many |
| [Securityscheme](#securityscheme)   | composes        | outbound  | many-to-many |
| [Oauthflows](#oauthflows)           | associated-with | inbound   | many-to-many |
...
| [Info](#info)                       | aggregates      | inbound   | many-to-many |
...
| Related Node                | Predicate       | Direction | Cardinality  |
| --------------------------- | --------------- | --------- | ------------ |
| [Mediatype](#mediatype)     | associated-with | outbound  | many-to-many |
| [Parameter](#parameter)     | associated-with | outbound  | many-to-many |
| [Header](#header)           | composes        | outbound  | many-to-many |
| [Header](#header)           | references      | outbound  | many-to-many |
| [Schema](#schema)           | references      | outbound  | many-to-many |
| [Mediatype](#mediatype)     | aggregates      | inbound   | many-to-many |
| [Mediatype](#mediatype)     | composes        | inbound   | many-to-many |
| [Requestbody](#requestbody) | associated-with | inbound   | many-to-many |
...
| --------------------------------- | --------------- | --------- | ------------ |
| [Components](#components)         | aggregates      | inbound   | many-to-many |
| [Operation](#operation)           | associated-with | outbound  | many-to-many |
| [Schema](#schema)                 | references      | outbound  | many-to-many |
| [Header](#header)                 | references      | inbound   | many-to-many |
| [Mediatype](#mediatype)           | aggregates      | inbound   | many-to-many |
| [Mediatype](#mediatype)           | references      | inbound   | many-to-many |
| [Parameter](#parameter)           | references      | inbound   | many-to-many |
| [Requestbody](#requestbody)       | aggregates      | inbound   | many-to-many |
| [Response](#response)             | references      | inbound   | many-to-many |
| [Servervariable](#servervariable) | references      | inbound   | many-to-many |
...
| Related Node                        | Predicate       | Direction | Cardinality  |
| ----------------------------------- | --------------- | --------- | ------------ |
| [Info](#info)                       | associated-with | outbound  | many-to-many |
| [Openapidocument](#openapidocument) | serves          | outbound  | many-to-many |
| [Operation](#operation)             | serves          | outbound  | many-to-many |
| [Schema](#schema)                   | serves          | outbound  | many-to-many |
| [Openapidocument](#openapidocument) | references      | inbound   | many-to-many |
| [Operation](#operation)             | references      | inbound   | many-to-many |
| [Pathitem](#pathitem)               | references      | inbound   | many-to-many |
| [Paths](#paths)                     | references      | inbound   | many-to-many |
| [Tag](#tag)                         | references      | inbound   | many-to-many |
...
| [Encoding](#encoding)             | composes        | inbound   | many-to-many |
| [Encoding](#encoding)             | references      | inbound   | many-to-many |
| [Securityscheme](#securityscheme) | associated-with | outbound  | many-to-many |
| [Example](#example)               | references      | outbound  | many-to-many |
| [Schema](#schema)                 | references      | outbound  | many-to-many |
| [Parameter](#parameter)           | specializes     | outbound  | many-to-many |
| [Mediatype](#mediatype)           | associated-with | inbound   | many-to-many |
| [Ratelimit](#ratelimit)           | associated-with | inbound   | many-to-many |
| [Response](#response)             | aggregates      | inbound   | many-to-many |
| [Response](#response)             | composes        | inbound   | many-to-many |
| [Responses](#responses)           | aggregates      | inbound   | many-to-many |
...
| Related Node                                    | Predicate       | Direction | Cardinality  |
| ----------------------------------------------- | --------------- | --------- | ------------ |
| [Externaldocumentation](#externaldocumentation) | associated-with | inbound   | many-to-many |
| [Contact](#contact)                             | aggregates      | outbound  | many-to-many |
| [License](#license)                             | aggregates      | outbound  | many-to-many |
| [Openapidocument](#openapidocument)             | associated-with | outbound  | many-to-many |
| [Openapidocument](#openapidocument)             | composes        | inbound   | many-to-many |
...
| [Server](#server)         | uses       | outbound  | many-to-many |
| [Response](#response)     | composes   | inbound   | many-to-many |
| [Responses](#responses)   | references | inbound   | many-to-many |
...
| Related Node                | Predicate       | Direction | Cardinality  |
| --------------------------- | --------------- | --------- | ------------ |
| [Encoding](#encoding)       | associated-with | inbound   | many-to-many |
| [Encoding](#encoding)       | aggregates      | outbound  | many-to-many |
| [Example](#example)         | aggregates      | outbound  | many-to-many |
| [Header](#header)           | associated-with | outbound  | many-to-many |
| [Encoding](#encoding)       | composes        | outbound  | many-to-many |
| [Schema](#schema)           | composes        | outbound  | many-to-many |
| [Example](#example)         | references      | outbound  | many-to-many |
| [Schema](#schema)           | references      | outbound  | many-to-many |
| [Requestbody](#requestbody) | serves          | outbound  | many-to-many |
| [Response](#response)       | serves          | outbound  | many-to-many |
| [Requestbody](#requestbody) | aggregates      | inbound   | many-to-many |
| [Requestbody](#requestbody) | composes        | inbound   | many-to-many |
| [Response](#response)       | aggregates      | inbound   | many-to-many |
| [Response](#response)       | composes        | inbound   | many-to-many |
...
| [Oauthflows](#oauthflows)         | associated-with | outbound  | many-to-many |
| [Ratelimit](#ratelimit)           | associated-with | outbound  | many-to-many |
| [Server](#server)                 | references      | outbound  | many-to-many |
| [Operation](#operation)           | serves          | outbound  | many-to-many |
| [Securityscheme](#securityscheme) | serves          | outbound  | many-to-many |
| [Oauthflows](#oauthflows)         | aggregates      | inbound   | many-to-many |
| [Oauthflows](#oauthflows)         | composes        | inbound   | many-to-many |
...
| Related Node                      | Predicate       | Direction | Cardinality  |
| --------------------------------- | --------------- | --------- | ------------ |
| [Oauthflow](#oauthflow)           | associated-with | inbound   | many-to-many |
| [Oauthflow](#oauthflow)           | aggregates      | outbound  | many-to-many |
| [Components](#components)         | associated-with | outbound  | many-to-many |
| [Operation](#operation)           | associated-with | outbound  | many-to-many |
| [Oauthflow](#oauthflow)           | composes        | outbound  | many-to-many |
| [Securityscheme](#securityscheme) | serves          | outbound  | many-to-many |
...
| [Externaldocumentation](#externaldocumentation) | serves          | inbound   | many-to-many |
| [Info](#info)                                   | associated-with | inbound   | many-to-many |
| [License](#license)                             | associated-with | inbound   | many-to-many |
| [Server](#server)                               | aggregates      | outbound  | many-to-many |
| [Tag](#tag)                                     | aggregates      | outbound  | many-to-many |
| [Components](#components)                       | composes        | outbound  | many-to-many |
| [Info](#info)                                   | composes        | outbound  | many-to-many |
| [Paths](#paths)                                 | composes        | outbound  | many-to-many |
| [Responses](#responses)                         | composes        | outbound  | many-to-many |
| [Schema](#schema)                               | composes        | outbound  | many-to-many |
| [Externaldocumentation](#externaldocumentation) | references      | outbound  | many-to-many |
| [Securityscheme](#securityscheme)               | requires        | outbound  | many-to-many |
...
- **Intra-Layer**: Inbound: 17 | Outbound: 14
...
| Related Node                                    | Predicate       | Direction | Cardinality  |
| ----------------------------------------------- | --------------- | --------- | ------------ |
| [Example](#example)                             | associated-with | inbound   | many-to-many |
| [Externaldocumentation](#externaldocumentation) | serves          | inbound   | many-to-many |
| [Link node](#link)                              | references      | inbound   | many-to-many |
| [Oauthflow](#oauthflow)                         | serves          | inbound   | many-to-many |
| [Oauthflows](#oauthflows)                       | associated-with | inbound   | many-to-many |
| [Parameter](#parameter)                         | aggregates      | outbound  | many-to-many |
| [Requestbody](#requestbody)                     | aggregates      | outbound  | many-to-many |
| [Server](#server)                               | aggregates      | outbound  | many-to-many |
| [Tag](#tag)                                     | aggregates      | outbound  | many-to-many |
| [Paths](#paths)                                 | composes        | outbound  | many-to-many |
| [Responses](#responses)                         | composes        | outbound  | many-to-many |
| [Schema](#schema)                               | composes        | outbound  | many-to-many |
| [Response](#response)                           | delivers        | outbound  | many-to-many |
| [Externaldocumentation](#externaldocumentation) | references      | outbound  | many-to-many |
| [Operation](#operation)                         | references      | outbound  | many-to-many |
| [Schema](#schema)                               | references      | outbound  | many-to-many |
| [Tag](#tag)                                     | references      | outbound  | many-to-many |
| [Callback](#callback)                           | triggers        | outbound  | many-to-many |
| [Securityscheme](#securityscheme)               | uses            | outbound  | many-to-many |
| [Parameter](#parameter)                         | references      | inbound   | many-to-many |
| [Pathitem](#pathitem)                           | composes        | inbound   | many-to-many |
| [Paths](#paths)                                 | serves          | inbound   | many-to-many |
| [Ratelimit](#ratelimit)                         | governs         | inbound   | many-to-many |
| [Ratelimit](#ratelimit)                         | serves          | inbound   | many-to-many |
| [Requestbody](#requestbody)                     | serves          | inbound   | many-to-many |
| [Schema](#schema)                               | references      | inbound   | many-to-many |
| [Securityscheme](#securityscheme)               | serves          | inbound   | many-to-many |
| [Servervariable](#servervariable)               | serves          | inbound   | many-to-many |
| [Tag](#tag)                                     | aggregates      | inbound   | many-to-many |
| [Tag](#tag)                                     | serves          | inbound   | many-to-many |

#### Inter-Layer Relationships

| Related Node                                                                  | Layer                                           | Predicate  | Direction | Cardinality  |
| ----------------------------------------------------------------------------- | ----------------------------------------------- | ---------- | --------- | ------------ |
| [Applicationfunction](./04-application-layer-report.md#applicationfunction)   | [Application](./04-application-layer-report.md) | realizes   | outbound  | many-to-many |
...
| [Businessinterface](./02-business-layer-report.md#businessinterface)          | [Business](./02-business-layer-report.md)       | references | outbound  | many-to-many |
| [Businessservice](./02-business-layer-report.md#businessservice)              | [Business](./02-business-layer-report.md)       | references | outbound  | many-to-many |
...
| [Securitypolicy](./03-security-layer-report.md#securitypolicy)                | [Security](./03-security-layer-report.md)       | requires   | outbound  | many-to-many |
...
| [Countermeasure](./03-security-layer-report.md#countermeasure)                | [Security](./03-security-layer-report.md)       | satisfies  | outbound  | many-to-many |
...
| [Applicationinterface](./04-application-layer-report.md#applicationinterface) | [Application](./04-application-layer-report.md) | uses       | outbound  | many-to-many |
...
| [Alert](./11-apm-layer-report.md#alert)                                       | [APM](./11-apm-layer-report.md)                 | monitors   | inbound   | many-to-many |
| [Dashboard](./11-apm-layer-report.md#dashboard)                               | [APM](./11-apm-layer-report.md)                 | monitors   | inbound   | many-to-many |
...
| [Traceconfiguration](./11-apm-layer-report.md#traceconfiguration)             | [APM](./11-apm-layer-report.md)                 | references | inbound   | many-to-many |
| [Schemadefinition](./07-data-model-layer-report.md#schemadefinition)          | [Data Model](./07-data-model-layer-report.md)   | serves     | inbound   | many-to-many |
| [Accesspattern](./08-data-store-layer-report.md#accesspattern)                | [Data Store](./08-data-store-layer-report.md)   | maps-to    | inbound   | many-to-many |
| [Collection](./08-data-store-layer-report.md#collection)                      | [Data Store](./08-data-store-layer-report.md)   | serves     | inbound   | many-to-many |
| [Storedlogic](./08-data-store-layer-report.md#storedlogic)                    | [Data Store](./08-data-store-layer-report.md)   | serves     | inbound   | many-to-many |
...
| [Stateaction](./09-ux-layer-report.md#stateaction)                            | [UX](./09-ux-layer-report.md)                   | triggers   | inbound   | many-to-many |
...
| [Components](#components)         | composes        | inbound   | many-to-many |
| [Encoding](#encoding)             | associated-with | inbound   | many-to-many |
| [Header](#header)                 | specializes     | inbound   | many-to-many |
| [Operation](#operation)           | aggregates      | inbound   | many-to-many |
| [Example](#example)               | references      | outbound  | many-to-many |
| [Operation](#operation)           | references      | outbound  | many-to-many |
| [Schema](#schema)                 | references      | outbound  | many-to-many |
| [Tag](#tag)                       | references      | outbound  | many-to-many |
| [Pathitem](#pathitem)             | aggregates      | inbound   | many-to-many |
| [Servervariable](#servervariable) | associated-with | inbound   | many-to-many |

#### Inter-Layer Relationships

| Related Node                                                            | Layer                                         | Predicate  | Direction | Cardinality  |
| ----------------------------------------------------------------------- | --------------------------------------------- | ---------- | --------- | ------------ |
| [Schemaproperty](./07-data-model-layer-report.md#schemaproperty)        | [Data Model](./07-data-model-layer-report.md) | maps-to    | inbound   | many-to-many |
| [Field](./08-data-store-layer-report.md#field)                          | [Data Store](./08-data-store-layer-report.md) | maps-to    | inbound   | many-to-many |
...
| Related Node                                    | Predicate  | Direction | Cardinality  |
| ----------------------------------------------- | ---------- | --------- | ------------ |
| [Callback](#callback)                           | aggregates | inbound   | many-to-many |
| [Parameter](#parameter)                         | aggregates | outbound  | many-to-many |
| [Server](#server)                               | aggregates | outbound  | many-to-many |
| [Operation](#operation)                         | composes   | outbound  | many-to-many |
| [Externaldocumentation](#externaldocumentation) | references | outbound  | many-to-many |
| [Pathitem](#pathitem)                           | references | outbound  | many-to-many |
| [Paths](#paths)                                 | aggregates | inbound   | many-to-many |
| [Paths](#paths)                                 | composes   | inbound   | many-to-many |
| [Ratelimit](#ratelimit)                         | serves     | inbound   | many-to-many |
| [Server](#server)                               | serves     | inbound   | many-to-many |
...
| [Server](#server)                               | aggregates      | outbound  | many-to-many |
| [Ratelimit](#ratelimit)                         | associated-with | outbound  | many-to-many |
| [Pathitem](#pathitem)                           | composes        | outbound  | many-to-many |
| [Externaldocumentation](#externaldocumentation) | references      | outbound  | many-to-many |
| [Tag](#tag)                                     | references      | outbound  | many-to-many |
| [Operation](#operation)                         | serves          | outbound  | many-to-many |
...
| --------------------------------- | --------------- | --------- | ------------ |
| [Oauthflow](#oauthflow)           | associated-with | inbound   | many-to-many |
| [Paths](#paths)                   | associated-with | inbound   | many-to-many |
| [Header](#header)                 | associated-with | outbound  | many-to-many |
| [Securityscheme](#securityscheme) | associated-with | outbound  | many-to-many |
| [Operation](#operation)           | governs         | outbound  | many-to-many |
| [Operation](#operation)           | serves          | outbound  | many-to-many |
| [Pathitem](#pathitem)             | serves          | outbound  | many-to-many |
| [Ratelimit](#ratelimit)           | specializes     | outbound  | many-to-many |
| [Response](#response)             | triggers        | outbound  | many-to-many |
| [Responses](#responses)           | associated-with | inbound   | many-to-many |
| [Server](#server)                 | associated-with | inbound   | many-to-many |
...
| ------------------------- | --------------- | --------- | ------------ |
| [Components](#components) | aggregates      | inbound   | many-to-many |
| [Mediatype](#mediatype)   | serves          | inbound   | many-to-many |
| [Operation](#operation)   | aggregates      | inbound   | many-to-many |
| [Example](#example)       | aggregates      | outbound  | many-to-many |
| [Mediatype](#mediatype)   | aggregates      | outbound  | many-to-many |
| [Encoding](#encoding)     | associated-with | outbound  | many-to-many |
| [Mediatype](#mediatype)   | composes        | outbound  | many-to-many |
| [Schema](#schema)         | references      | outbound  | many-to-many |
| [Operation](#operation)   | serves          | outbound  | many-to-many |
...
| [Objectschema](./07-data-model-layer-report.md#objectschema)   | [Data Model](./07-data-model-layer-report.md) | maps-to   | inbound   | many-to-many |
| [Collection](./08-data-store-layer-report.md#collection)       | [Data Store](./08-data-store-layer-report.md) | maps-to   | inbound   | many-to-many |
...
| [Components](#components) | composes   | inbound   | many-to-many |
| [Mediatype](#mediatype)   | serves     | inbound   | many-to-many |
| [Operation](#operation)   | delivers   | inbound   | many-to-many |
| [Ratelimit](#ratelimit)   | triggers   | inbound   | many-to-many |
| [Header](#header)         | aggregates | outbound  | many-to-many |
| [Mediatype](#mediatype)   | aggregates | outbound  | many-to-many |
| [Schema](#schema)         | aggregates | outbound  | many-to-many |
| [Header](#header)         | composes   | outbound  | many-to-many |
| [Link node](#link)        | composes   | outbound  | many-to-many |
| [Mediatype](#mediatype)   | composes   | outbound  | many-to-many |
| [Example](#example)       | references | outbound  | many-to-many |
| [Schema](#schema)         | references | outbound  | many-to-many |
| [Responses](#responses)   | composes   | inbound   | many-to-many |

#### Inter-Layer Relationships

| Related Node                                                  | Layer                                         | Predicate | Direction | Cardinality  |
| ------------------------------------------------------------- | --------------------------------------------- | --------- | --------- | ------------ |
| [Arrayschema](./07-data-model-layer-report.md#arrayschema)    | [Data Model](./07-data-model-layer-report.md) | maps-to   | inbound   | many-to-many |
| [Objectschema](./07-data-model-layer-report.md#objectschema)  | [Data Model](./07-data-model-layer-report.md) | maps-to   | inbound   | many-to-many |
| [View](./08-data-store-layer-report.md#view)                  | [Data Store](./08-data-store-layer-report.md) | realizes  | inbound   | many-to-many |
...
| [Dataconfig](./09-ux-layer-report.md#dataconfig)              | [UX](./09-ux-layer-report.md)                 | maps-to   | inbound   | many-to-many |
| [Errorconfig](./09-ux-layer-report.md#errorconfig)            | [UX](./09-ux-layer-report.md)                 | maps-to   | inbound   | many-to-many |
...
| [Ratelimit](#ratelimit)             | associated-with | outbound  | many-to-many |
| [Response](#response)               | composes        | outbound  | many-to-many |
| [Link node](#link)                  | references      | outbound  | many-to-many |
| [Schema](#schema)                   | references      | outbound  | many-to-many |
...
- **Intra-Layer**: Inbound: 20 | Outbound: 4
...
| [Components](#components)                       | composes        | inbound   | many-to-many |
| [Encoding](#encoding)                           | references      | inbound   | many-to-many |
| [Example](#example)                             | references      | inbound   | many-to-many |
| [Externaldocumentation](#externaldocumentation) | serves          | inbound   | many-to-many |
| [Header](#header)                               | references      | inbound   | many-to-many |
| [Link node](#link)                              | references      | inbound   | many-to-many |
| [Mediatype](#mediatype)                         | composes        | inbound   | many-to-many |
...
| [Operation](#operation)                         | references      | inbound   | many-to-many |
| [Parameter](#parameter)                         | references      | inbound   | many-to-many |
| [Requestbody](#requestbody)                     | references      | inbound   | many-to-many |
| [Response](#response)                           | aggregates      | inbound   | many-to-many |
| [Response](#response)                           | references      | inbound   | many-to-many |
| [Responses](#responses)                         | aggregates      | inbound   | many-to-many |
| [Responses](#responses)                         | references      | inbound   | many-to-many |
...
| [Tag](#tag)                                     | associated-with | inbound   | many-to-many |
...
| [Reference](./07-data-model-layer-report.md#reference)               | [Data Model](./07-data-model-layer-report.md) | maps-to   | inbound   | many-to-many |
...
- **Intra-Layer**: Inbound: 9 | Outbound: 2
...
| ----------------------------------- | --------------- | --------- | ------------ |
| [Components](#components)           | composes        | inbound   | many-to-many |
| [Header](#header)                   | associated-with | inbound   | many-to-many |
| [Oauthflow](#oauthflow)             | serves          | inbound   | many-to-many |
| [Oauthflows](#oauthflows)           | serves          | inbound   | many-to-many |
| [Openapidocument](#openapidocument) | requires        | inbound   | many-to-many |
| [Operation](#operation)             | uses            | inbound   | many-to-many |
| [Ratelimit](#ratelimit)             | associated-with | inbound   | many-to-many |
| [Oauthflows](#oauthflows)           | composes        | outbound  | one-to-one   |
| [Operation](#operation)             | serves          | outbound  | many-to-many |
| [Server](#server)                   | references      | inbound   | many-to-many |
| [Tag](#tag)                         | associated-with | inbound   | many-to-many |
...
| [Collection](./08-data-store-layer-report.md#collection)                      | [Data Store](./08-data-store-layer-report.md)   | maps-to    | outbound  | many-to-many |
| [Actor](./03-security-layer-report.md#actor)                                  | [Security](./03-security-layer-report.md)       | maps-to    | outbound  | many-to-many |
| [Applicationcomponent](./04-application-layer-report.md#applicationcomponent) | [Application](./04-application-layer-report.md) | references | outbound  | many-to-many |
| [Applicationservice](./04-application-layer-report.md#applicationservice)     | [Application](./04-application-layer-report.md) | references | outbound  | many-to-many |
| [Businessinterface](./02-business-layer-report.md#businessinterface)          | [Business](./02-business-layer-report.md)       | references | outbound  | many-to-many |
| [Businessservice](./02-business-layer-report.md#businessservice)              | [Business](./02-business-layer-report.md)       | references | outbound  | many-to-many |
| [Secureresource](./03-security-layer-report.md#secureresource)                | [Security](./03-security-layer-report.md)       | references | outbound  | many-to-many |
...
| [View](./09-ux-layer-report.md#view)                                          | [UX](./09-ux-layer-report.md)                   | uses       | inbound   | many-to-many |
...
| Related Node                        | Predicate       | Direction | Cardinality  |
| ----------------------------------- | --------------- | --------- | ------------ |
| [Callback](#callback)               | uses            | inbound   | many-to-many |
| [Link node](#link)                  | uses            | inbound   | many-to-many |
| [Oauthflow](#oauthflow)             | references      | inbound   | many-to-many |
| [Openapidocument](#openapidocument) | aggregates      | inbound   | many-to-many |
| [Operation](#operation)             | aggregates      | inbound   | many-to-many |
| [Pathitem](#pathitem)               | aggregates      | inbound   | many-to-many |
| [Paths](#paths)                     | aggregates      | inbound   | many-to-many |
| [Servervariable](#servervariable)   | aggregates      | outbound  | many-to-many |
| [Ratelimit](#ratelimit)             | associated-with | outbound  | many-to-many |
| [Securityscheme](#securityscheme)   | references      | outbound  | many-to-many |
| [Pathitem](#pathitem)               | serves          | outbound  | many-to-many |
| [Servervariable](#servervariable)   | governs         | inbound   | many-to-many |
...
| Related Node            | Predicate       | Direction | Cardinality  |
| ----------------------- | --------------- | --------- | ------------ |
| [Server](#server)       | aggregates      | inbound   | many-to-many |
| [Parameter](#parameter) | associated-with | outbound  | many-to-many |
| [Server](#server)       | governs         | outbound  | many-to-many |
| [Example](#example)     | references      | outbound  | many-to-many |
| [Operation](#operation) | serves          | outbound  | many-to-many |
...
| ----------------------------------------------- | --------------- | --------- | ------------ |
| [Link node](#link)                              | references      | inbound   | many-to-many |
| [Oauthflow](#oauthflow)                         | aggregates      | inbound   | many-to-many |
| [Openapidocument](#openapidocument)             | aggregates      | inbound   | many-to-many |
| [Operation](#operation)                         | aggregates      | inbound   | many-to-many |
| [Operation](#operation)                         | references      | inbound   | many-to-many |
| [Parameter](#parameter)                         | references      | inbound   | many-to-many |
| [Paths](#paths)                                 | references      | inbound   | many-to-many |
| [Schema](#schema)                               | references      | inbound   | many-to-many |
| [Operation](#operation)                         | aggregates      | outbound  | many-to-many |
| [Schema](#schema)                               | associated-with | outbound  | many-to-many |
| [Securityscheme](#securityscheme)               | associated-with | outbound  | many-to-many |
| [Externaldocumentation](#externaldocumentation) | references      | outbound  | many-to-many |
| [Operation](#operation)                         | serves          | outbound  | many-to-many |
...
_Generated: 2026-04-04T12:20:35.640Z | Spec Version: 0.8.3 | Generator: generate-layer-reports.ts_
