...
node ~/path/to/documentation_robotics/cli-bun/dist/cli.js init --name "Test Project"
```
...
Create `.vscode/launch.json` in `cli-bun/` directory:
...
- **Specification:** `../spec/`
- **Compatibility Tests:** `cli-bun/tests/compatibility/README.md`
