...
```
1. Update cli/src/documentation_robotics/spec_version.py
   └── SPEC_VERSION = "0.5.0"  # Must match existing spec release

2. Update cli/src/documentation_robotics/__init__.py
   └── __version__ = "0.7.2"
...
| `cli/src/.../spec_version.py`     | CLI's spec version reference     | Yes            |
