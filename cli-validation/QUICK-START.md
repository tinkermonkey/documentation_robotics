...
```bash
npm run test:fs-compatibility:verbose
```
...
npm run test:fs-compatibility -- --test-case="element" --fast-fail --verbose
```
...
npm run test:fs-compatibility:high
```
...
npm run test:fs-compatibility -- --fast-fail

# Verbose output with high-priority tests
npm run test:fs-compatibility -- --priority=high --verbose

# Generate JUnit XML output
npm run test:fs-compatibility -- --reporter=junit --output=results/junit.xml

# Run specific test by name
npm run test:fs-compatibility -- --test-case="element-crud"
...
npm run test:fs-compatibility -- --test-case="element"
```
...
```bash
npm run test:fs-compatibility -- --test-case="business-services" --verbose
