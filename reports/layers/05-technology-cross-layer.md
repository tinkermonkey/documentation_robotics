...
| Predicate                 | Source Element    | Target Element        | Field Path                                                     | Description                                 | Documented                                 |
| ------------------------- | ----------------- | --------------------- | -------------------------------------------------------------- | ------------------------------------------- | ------------------------------------------ |
| `health-check-endpoint`   | TechnologyService | HealthCheckEndpoint   | `apm.health-check-endpoint`                                    | health check endpoint                       | [✓](../../spec/schemas/link-registry.json) |
| `health-monitored`        | TechnologyService | HealthMonitored       | `apm.health-monitored`                                         | whether health is actively monitored        | [✓](../../spec/schemas/link-registry.json) |
| `sla-target-availability` | TechnologyService | SlaTargetAvailability | `apm.sla-target-availability`, `x-apm-sla-target-availability` | string (e.g., "99.95%", "99.99%", optional) | [✓](../../spec/schemas/link-registry.json) |
| `sla-target-latency`      | TechnologyService | SlaTargetLatency      | `apm.sla-target-latency`, `x-apm-sla-target-latency`           | string (e.g., "200ms", "500ms", optional)   | [✓](../../spec/schemas/link-registry.json) |
