...
graph TB
  subgraph "Motivation Layer"
    ...
    Stakeholder -->|association| Goal
    Stakeholder -->|association| Driver
    Stakeholder -->|association| Requirement
    Driver -->|association| Stakeholder
...
|-------------------|---------------|-----------|--------|--------|------------|------------|
| influence | Goal | `influence` | XML | xml_example | ✓ | ✗ |
...
|-------------------|---------------|-----------|--------|--------|------------|------------|
| influence | Driver | `influence` | XML | xml_example | ✓ | ✗ |
...
| Relationship Type | Target Entity | Predicate | Status | Source | In Catalog | Documented |
|-------------------|---------------|-----------|--------|--------|------------|------------|
| influence | Requirement | `influence` | XML | xml_example | ✓ | ✗ |

### Incoming Relationships (Other Entities → Constraint)

| Relationship Type | Source Entity | Predicate | Status | Source | In Catalog | Documented |
|-------------------|---------------|-----------|--------|--------|------------|------------|
| influence | Principle | `influence` | XML | xml_example | ✓ | ✗ |
| association | Requirement | `association` | XML | xml_example | ✓ | ✗ |
...
| Relationship Type | Target Entity | Predicate | Status | Source | In Catalog | Documented |
|-------------------|---------------|-----------|--------|--------|------------|------------|
| influence | Assessment | `influence` | XML | xml_example | ✓ | ✗ |
| influence | Goal | `influence` | XML | xml_example | ✓ | ✗ |
| association | Stakeholder | `association` | XML | xml_example | ✓ | ✗ |
...
| Relationship Type | Target Entity | Predicate | Status | Source | In Catalog | Documented |
|-------------------|---------------|-----------|--------|--------|------------|------------|
| aggregation | Goal | `aggregates` | XML | xml_example | ✓ | ✗ |
| influence | Principle | `influence` | XML | xml_example | ✓ | ✗ |
| influence | Requirement | `influence` | XML | xml_example | ✓ | ✗ |
| realization | Value | `realizes` | XML | xml_example | ✓ | ✗ |
...
| influence | Driver | `influence` | XML | xml_example | ✓ | ✗ |
| aggregation | Goal | `aggregates` | XML | xml_example | ✓ | ✗ |
| influence | Outcome | `influence` | XML | xml_example | ✓ | ✗ |
| realization | Outcome | `realizes` | XML | xml_example | ✓ | ✗ |
| association | Stakeholder | `association` | XML | xml_example | ✓ | ✗ |
...
| Relationship Type | Target Entity | Predicate | Status | Source | In Catalog | Documented |
|-------------------|---------------|-----------|--------|--------|------------|------------|
| association | Outcome | `association` | XML | xml_example | ✓ | ✗ |
| association | Value | `association` | XML | xml_example | ✓ | ✗ |
...
|-------------------|---------------|-----------|--------|--------|------------|------------|
| influence | Goal | `influence` | XML | xml_example | ✓ | ✗ |
| realization | Goal | `realizes` | XML | xml_example | ✓ | ✗ |
| association | Value | `association` | XML | xml_example | ✓ | ✗ |
...
| Relationship Type | Source Entity | Predicate | Status | Source | In Catalog | Documented |
|-------------------|---------------|-----------|--------|--------|------------|------------|
| association | Meaning | `association` | XML | xml_example | ✓ | ✗ |
...
| Relationship Type | Target Entity | Predicate | Status | Source | In Catalog | Documented |
|-------------------|---------------|-----------|--------|--------|------------|------------|
| influence | Constraint | `influence` | XML | xml_example | ✓ | ✗ |
| influence | Requirement | `influence` | XML | xml_example | ✓ | ✗ |
...
| Relationship Type | Target Entity | Predicate | Status | Source | In Catalog | Documented |
|-------------------|---------------|-----------|--------|--------|------------|------------|
| association | Constraint | `association` | XML | xml_example | ✓ | ✗ |
| aggregation | Requirement | `aggregates` | XML | xml_example | ✓ | ✗ |
| influence | Requirement | `influence` | XML | xml_example | ✓ | ✗ |
...
| Relationship Type | Target Entity | Predicate | Status | Source | In Catalog | Documented |
|-------------------|---------------|-----------|--------|--------|------------|------------|
| association | Driver | `association` | XML | xml_example | ✓ | ✗ |
| association | Goal | `association` | XML | xml_example | ✓ | ✗ |
| association | Requirement | `association` | XML | xml_example | ✓ | ✗ |
...
- **Total Intra-Layer Relationships**: 23
- **Average Relationships per Entity**: 4.6
