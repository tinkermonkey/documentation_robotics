...
|-------------------|---------------|-----------|--------|--------|------------|------------|
| assignment | Node | `assigned-to` | XML | xml_example | ✓ | ✗ |
...
|-------------------|---------------|-----------|--------|--------|------------|------------|
| association | Node | `association` | XML | xml_example | ✓ | ✗ |
...
| Relationship Type | Target Entity | Predicate | Status | Source | In Catalog | Documented |
|-------------------|---------------|-----------|--------|--------|------------|------------|
| association | CommunicationNetwork | `association` | XML | xml_example | ✓ | ✗ |
| realization | TechnologyService | `realizes` | XML | xml_example | ✓ | ✗ |

### Incoming Relationships (Other Entities → Node)

| Relationship Type | Source Entity | Predicate | Status | Source | In Catalog | Documented |
|-------------------|---------------|-----------|--------|--------|------------|------------|
| assignment | Artifact | `assigned-to` | XML | xml_example | ✓ | ✗ |
| assignment | SystemSoftware | `assigned-to` | XML | xml_example | ✓ | ✗ |
...
| Relationship Type | Source Entity | Predicate | Status | Source | In Catalog | Documented |
|-------------------|---------------|-----------|--------|--------|------------|------------|
| realization | Node | `realizes` | XML | xml_example | ✓ | ✗ |
...
- **Total Intra-Layer Relationships**: 4
- **Average Relationships per Entity**: 0.6
